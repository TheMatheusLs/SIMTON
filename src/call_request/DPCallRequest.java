package call_request; // NOPMD by Andr� on 20/06/17 14:51
...
public class DPCallRequest{ // NOPMD by Andr� on 05/06/17 12:15
    ...
    /**
  	 * Objeto com um conjunto de fun��es implementadas.
  	 * @author Andr� 			
  	 */	 
    private final transient Function function = new Function();
    /**
	...
	/**
   	 ...
   	 * @author Andr� 			
   	 */		
	public void setTime(final double time, final double meanDurationRate){		
		this.decayTime = time + this.function.exponencial(meanDurationRate);
	...
	/**
   	 ...
   	 * @author Andr� 			
   	 */	
	public void allocate(final RoutingAlgorithmSolution workingPath, final RoutingAlgorithmSolution protectionPath, final List<OpticalSwitch> listOfNodes){ // NOPMD by Andr� on 20/06/17 14:50
		...
		if(this.callRequestType.equals(CallRequestType.BIDIRECTIONAL)){				
