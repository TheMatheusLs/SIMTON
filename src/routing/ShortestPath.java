...
/**
 * Descreve o algoritmo de roteamento Shortest Path.
 * @author Andr� 
 */
public class ShortestPath implements IRoutingAlgorithm { // NOPMD by Andr� on 16/06/17 10:19
	/**
	 * Inst�ncia da Classe.
	 * @author Andr� 			
	 */		
	private static final ShortestPath SP_INSTANCE = new ShortestPath();	
	/**
	 * M�todo para encontrar uma rota baseado na dist�ncia f�sica.
	 * @author Andr� 			
	 */		
	public List<RoutingAlgorithmSolution> findRoute(final OpticalLink[][] network, int originNode,  int destinationNode, final List<OpticalSwitch> listOfNodes) throws InvalidNodeIdException{
	 ...
	 * @return O objeto SP_INSTANCE
	 * @author Andr� 			
	 */		
	public static ShortestPath getShortestPathInstance(){
		return SP_INSTANCE;
	}
}
